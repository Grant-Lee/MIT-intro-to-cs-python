...
class Mortgage(object):
    ...
    def makePayment(self):
        '''Make a payment'''
        #add payment to paid list
        self.paid.append(self.payment)
        #calculate reduction by subtracting payment by interest
        reduction = self.payment - self.owed[-1]*self.rate
        #subtract principal from loam then append and update owed amount and list
...
# fixed-rate mortgage (same as Mortgage with a different legend)
class Fixed(Mortgage):
    def __init__(self, loan, r, months):
        Mortgage.__init__(self, loan, r, months)
        self.legend = "Fixed, " + str(r*100) + '%'
        
# Fixed Rate with up-front points
...
class TwoRate(Mortgage):
    def __init__(self, loan, r, months, teaserRate, teaserMonths):
        ...
        self.legend = str(self.teaserRate*100)\
